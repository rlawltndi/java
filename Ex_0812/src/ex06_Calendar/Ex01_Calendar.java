...
public class Ex01_Calendar {
	public static void main(String[] args) {
		...
		//선언된 객체를 받아오는 형식으로 선언한다.
		
		Calendar cal = Calendar.getInstance();
		
		//Calendar클래스의 속성
		//YEAR,MONTH,DATE 연,월(0-11),일(1-31)을 나타내는 상수
		//DAY_OF_MONTH 현재 달의 몇 번째 날인지 나타내는 상수
		//DAT_OF_WEEK 현재 주의 몇번째 요일인지 나타내는 숭수(1-7).1이 일요일
		//HOUR,MINUTE 시,분을 나타내는 상수
		//SECOND,MILLISECOND초 , 밀리 초를 나타내는 상수
		//HOUR_OF_DAY 현재 날의 시각을 의미하는 상수
		//AM_PM HOUR가 정오보다 이전이면 0을,이후이면 1의 값을 가지는 상수
		//WOOK_OF_MONTH 현재 달의 몇 번재 주인지를 나타내는 상수
